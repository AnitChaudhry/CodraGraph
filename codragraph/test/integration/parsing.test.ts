  ...
  describe('isNodeExported', () => {
    ...
    describe('rust', () => {
      it('pub function is exported', () => {
        ...
        const _fnDecl = mockNode('function_item', 'pub fn foo() {}', undefined, [visMod, nameNode]);
        expect(isNodeExported(nameNode, 'foo', 'rust')).toBe(true);
      });

      it('non-pub function is not exported', () => {
        const nameNode = mockNode('identifier', 'foo');
        const _fnDecl = mockNode('function_item', 'fn foo() {}', undefined, [nameNode]);
    ...
    describe('c/cpp', () => {
      it('C functions without static are exported (external linkage)', () => {
        ...
        const _fnDef = mockNode('function_definition', 'int add(int a, int b) {}', undefined, [
          nameNode,
        ]);
      ...
      it('C++ functions without static are exported', () => {
        ...
        const _fnDef = mockNode('function_definition', 'void helperFunction() {}', undefined, [
          nameNode,
        ]);
    ...
    describe('csharp', () => {
      it('public modifier means exported', () => {
        ...
        const _methodDecl = mockNode('method_declaration', 'public int Add() {}', undefined, [
          modifier,
          nameNode,
        ]);
      ...
      it('no public modifier means not exported', () => {
        ...
        const _classDecl = mockNode('class_declaration', 'class Helper {}', undefined, [nameNode]);
    ...
    describe('java', () => {
      it('public method is exported', () => {
        ...
        const _methodDecl = mockNode('method_declaration', 'public User getUser() {}', undefined, [
          modifiers,
          nameNode,
        ]);
      ...
      it('public class method via text check is exported', () => {
        ...
        const _methodDecl = mockNode('method_declaration', 'public void doGet() {}', undefined, [
          nameNode,
        ]);
      ...
      it('private method is not exported', () => {
        ...
        const nameNode = mockNode('identifier', 'helper');
        const _methodDecl = mockNode('method_declaration', 'private void helper() {}', undefined, [
          modifiers,
          nameNode,
        ]);
      ...
      it('package-private (no modifier) is not exported', () => {
        ...
        const _methodDecl = mockNode('method_declaration', 'void internal() {}', undefined, [
          nameNode,
        ]);
    ...
    describe('kotlin', () => {
      it('function without visibility modifier is public by default', () => {
        ...
        const _fnDecl = mockNode('function_declaration', 'fun greet() {}', undefined, [nameNode]);
      ...
      it('public function is exported', () => {
        ...
        const nameNode = mockNode('identifier', 'greet');
        const _fnDecl = mockNode('function_declaration', 'public fun greet() {}', undefined, [
          modifiers,
          nameNode,
        ]);
        expect(isNodeExported(nameNode, 'greet', 'kotlin')).toBe(true);
      ...
      it('private function is not exported', () => {
        ...
        const _fnDecl = mockNode('function_declaration', 'private fun secret() {}', undefined, [
          modifiers,
          nameNode,
        ]);
    ...
    describe('csharp additional', () => {
      ...
      it('struct with public modifier is exported', () => {
        ...
        const _structDecl = mockNode('struct_declaration', 'public struct Point {}', undefined, [
          modifier,
          nameNode,
        ]);
      ...
      it('enum with public modifier is exported', () => {
        ...
        const _enumDecl = mockNode('enum_declaration', 'public enum Status {}', undefined, [
          modifier,
          nameNode,
        ]);
      ...
      it('record with public modifier is exported', () => {
        ...
        const _recordDecl = mockNode('record_declaration', 'public record UserDto {}', undefined, [
          modifier,
          nameNode,
        ]);
    ...
    describe('rust additional', () => {
      it('pub(crate) is exported', () => {
        ...
        const _fnDecl = mockNode('function_item', 'pub(crate) fn internal_fn() {}', undefined, [
          visMod,
          nameNode,
        ]);
      ...
      it('pub struct is exported', () => {
        ...
        const _structDecl = mockNode('struct_item', 'pub struct Config {}', undefined, [
          visMod,
          nameNode,
        ]);
      ...
      it('private struct is not exported', () => {
        ...
        const _structDecl = mockNode('struct_item', 'struct Inner {}', undefined, [nameNode]);
      ...
      it('pub enum is exported', () => {
        ...
        const _enumDecl = mockNode('enum_item', 'pub enum ErrorKind {}', undefined, [
          visMod,
          nameNode,
        ]);
      ...
      it('pub trait is exported', () => {
        ...
        const _traitDecl = mockNode('trait_item', 'pub trait Handler {}', undefined, [
          visMod,
          nameNode,
        ]);
    ...
    describe('c/cpp additional', () => {
      it('static C++ function is not exported', () => {
        ...
        const staticSpec = mockNode('storage_class_specifier', 'static');
        const _fnDef = mockNode('function_definition', 'static int localHelper() {}', undefined, [
          staticSpec,
          nameNode,
        ]);
      ...
      it('declaration (not definition) without static is exported', () => {
        ...
        const _decl = mockNode('declaration', 'int compute(int x);', undefined, [nameNode]);
      ...
      it('static declaration is not exported', () => {
        ...
        const staticSpec = mockNode('storage_class_specifier', 'static');
        const _decl = mockNode('declaration', 'static int internalFn(void);', undefined, [
          staticSpec,
          nameNode,
        ]);
    ...
    describe('c/cpp edge cases', () => {
      ...
      it('static function inside named namespace is not exported', () => {
        ...
        const _ns = mockNode('namespace_definition', 'namespace foo { }', undefined, [fnDef], {
      ...
      it('extern storage class is not confused with static', () => {
        ...
        const _fnDef = mockNode('function_definition', 'extern void externFn() {}', undefined, [
          externSpec,
          nameNode,
        ]);
    ...
    describe('rust edge cases', () => {
      it('pub(super) is treated as exported', () => {
        ...
        const _fnDecl = mockNode('function_item', 'pub(super) fn parent_fn() {}', undefined, [
          visMod,
          nameNode,
        ]);
      ...
      it('pub union is exported', () => {
        ...
        const _unionDecl = mockNode('union_item', 'pub union MyUnion {}', undefined, [
          visMod,
          nameNode,
        ]);
      ...
      it('private union is not exported', () => {
        ...
        const _unionDecl = mockNode('union_item', 'union InternalUnion {}', undefined, [nameNode]);
      ...
      it('pub type alias is exported', () => {
        ...
        const _typeDecl = mockNode('type_item', 'pub type Result = ...', undefined, [
          visMod,
          nameNode,
        ]);
      ...
      it('pub const is exported', () => {
        ...
        const _constDecl = mockNode('const_item', 'pub const MAX_SIZE: usize = 100;', undefined, [
          visMod,
          nameNode,
        ]);
      ...
      it('private const is not exported', () => {
        ...
        const _constDecl = mockNode('const_item', 'const INTERNAL_LIMIT: usize = 50;', undefined, [
          nameNode,
        ]);
      ...
      it('pub static is exported', () => {
        ...
        const _staticDecl = mockNode('static_item', 'pub static INSTANCE: ...', undefined, [
          visMod,
          nameNode,
        ]);
      ...
      it('associated_type without pub is not exported', () => {
        ...
        const _assocType = mockNode('associated_type', 'type Item;', undefined, [nameNode]);
    ...
    describe('csharp edge cases', () => {
      ...
      it('file_scoped_namespace_declaration is a valid context', () => {
        ...
        const _classDecl = mockNode('class_declaration', 'public class MyClass {}', undefined, [
          modifier,
          nameNode,
        ]);
    ...
    describe('kotlin edge cases', () => {
      it('protected function is not exported', () => {
        ...
        const nameNode = mockNode('identifier', 'onInit');
        const _fnDecl = mockNode('function_declaration', 'protected fun onInit() {}', undefined, [
          modifiers,
          nameNode,
        ]);
