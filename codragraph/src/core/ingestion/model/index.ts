...
// `SymbolDefinition` moved to `codragraph-shared` (RFC #909 Ring 1 #910).
// Consumers should import it directly from `codragraph-shared`, not via this barrel.
...
// `MroStrategy` itself lives in `codragraph-shared`; re-exported here for
