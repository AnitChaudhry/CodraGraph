# Draft: Codragraph Brainstorming - Clustering & Process Maps

## Initial Context
- Project: **CodragraphV2**
- Structure: 
    - `codragraph/` (Likely the core application)
    - `codragraph-mcp/` (Likely a Model Context Protocol server)
- Goal: Make it accurate and usable for smaller/dumber models.
- Current Focus: Implementing **Clustering** and **Process Maps**.

## Findings
- **Clustering**: Found `codragraph/src/core/ingestion/cluster-enricher.ts`.
