...
**File:** `packages/core/src/core/group/storage.ts`
...
**File:** `packages/core/src/core/group/extractors/grpc-extractor.ts`
...
**File:** `packages/core/src/core/group/service-boundary-detector.ts`
