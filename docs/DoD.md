...
- CLI, MCP, and HTTP-bridge behavior in `packages/core/`
...
- [ ] Existing contracts (types in `packages/shared/`, CLI flags, MCP tools/resources, HTTP routes, graph node/edge shapes, persisted IDs) are preserved unless the task explicitly requires a contract change.
...
- A contract drifted between `packages/core/`, `apps/web/`, and `packages/shared/` and only one side was updated.
...
| Date       | Version | Change                                                                                                                                                        |
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-05-25 | 2.1.2   | Added FeatureCluster context-pack validation expectations and clarified cross-package build order for the shared, harness, SDK, compress, and org surfaces. |
