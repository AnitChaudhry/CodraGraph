...
//
// Source locations:
//   validLabel / validRelType  -- codragraph-web/src/core/llm/tools.ts
//   isSafeId                   -- codragraph-web/src/components/ProcessesPanel.tsx
//   readOnly guard (regex)     -- codragraph-web/src/core/cgdb/cgdb-adapter.ts
// ---------------------------------------------------------------------------
