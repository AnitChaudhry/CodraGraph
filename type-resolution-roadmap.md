...
This roadmap describes the evolution of CodraGraph's type-resolution layer from a receiver-disambiguation aid into a production-grade static-analysis foundation.
...
For CodraGraph, production-grade does **not** mean replacing a language compiler. The target:
