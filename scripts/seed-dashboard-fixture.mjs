 ...
 *   - .codragraph/cgdb file (created by `codragraph serve` on first
 *     query; we leave it absent — the dashboard's Overview / History /
 *     Recipes sections don't depend on cgdb)
...
import { FsRecipeStore } from '../packages/harness/dist/moat/recipe-store.js';
