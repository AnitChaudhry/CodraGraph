 ...
 *
 * All tests share one withTestCgdbDB lifecycle to avoid cross-block
...
import { initCgdb, executeQuery, closeCgdb } from '../../src/mcp/core/cgdb-adapter.js';
...
withTestCgdbDB(
  ...
  (handle) => {
    ...
    // LAST: triggers closeCgdb internally which may affect shared state
