 ...
 *   - https://codragraph.vercel.app     → allowed
...
describe('isAllowedOrigin: vercel.app', () => {
  it('allows https://codragraph.vercel.app', () => {
    expect(isAllowedOrigin('https://codragraph.vercel.app')).toBe(true);
  });
...
describe('isAllowedOrigin: rejected origins', () => {
  ...
  it('rejects https://codragraph.example.com (not the official domain)', () => {
    expect(isAllowedOrigin('https://codragraph.example.com')).toBe(false);
  });
