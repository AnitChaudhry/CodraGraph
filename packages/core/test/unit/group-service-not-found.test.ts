...
const getGroupDirMock = vi.fn(() => '/fake/.codragraph/groups/missing');
const getDefaultCodragraphDirMock = vi.fn(() => '/fake/.codragraph');
...
vi.mock('../../src/core/group/storage.js', () => ({
  getDefaultCodragraphDir: getDefaultCodragraphDirMock,
