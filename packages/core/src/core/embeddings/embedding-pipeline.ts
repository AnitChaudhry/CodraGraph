...
import { loadVectorExtension } from '../cgdb/cgdb-adapter.js';
import { decodeContentField } from '../cgdb/content-read.js';
 ...
 * Delegates extension loading to cgdb-adapter's loadVectorExtension(),
