 ...
 *
 * 1. Add the variant to the `NodeLabel` union in `@codragraph/shared/src/graph/types.ts`.
 ...
 *
 * Adding a new NodeLabel to `@codragraph/shared`: TypeScript will flag this
