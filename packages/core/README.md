...
```bash
# macOS / Linux
claude mcp add codragraph -- npx -y @codragraph/cli@2.2.0-rc.2 mcp

# Windows
claude mcp add codragraph -- cmd /c npx -y @codragraph/cli@2.2.0-rc.2 mcp
```

### Codex (full support — MCP + skills)

```bash
codex mcp add codragraph -- npx -y @codragraph/cli@2.2.0-rc.2 mcp
```
...
```bash
npx @codragraph/cli@2.2.0-rc.2 analyze     # no global install
# or
npm install -g @codragraph/cli@2.2.0-rc.2  # upgrade a global install
```
