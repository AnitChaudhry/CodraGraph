...
Tests how well factual information is preserved after codragraph compression using question-answering verification.
...
├── llm.py       # Benchmark script for LLM-based compression
├── nlp.py   # Benchmark script for NLP-based compression
...
# Specify output file
python benchmark/factual_preservation/llm.py --output my_results.json

# Use different model
python benchmark/factual_preservation/llm.py --model gpt-4o-mini

# Quiet mode
python benchmark/factual_preservation/llm.py --quiet
```
...
python benchmark/factual_preservation/nlp.py --lang es

# Specify output file
python benchmark/factual_preservation/nlp.py --output my_results.json

# Use different model for verification (not compression)
python benchmark/factual_preservation/nlp.py --model gpt-4o-mini

# Quiet mode
python benchmark/factual_preservation/nlp.py --quiet
```
...
2. Compresses each text using codragraph compression
3. For each fact:
